<template>
  <div class="main-back">
    <div class="container mt-5 mb-5 m-auto bg-white p-5 bod-3">
      <div class="row">
        <!-- CARD FORM -->
          ...
          <form>
            <div class="header flex-between flex-vertical-center">
              <div class="flex-vertical-center">
                ...
                <span class="title">
                  <strong>TechCareer</strong><span>Pay</span>
                </span>
              </div>
            </div>
            <div class="card-mockup flex-vertical">
              ...
              <div>
                ...
                <div class="size-md pb-md">
                  <strong>
                    <span id="carddigits_mock">{{payment.creditcard}}</span>
                  </strong>
                </div>
                <div class="flex-between flex-vertical-center">
                  <strong class="size-md">
                    <span>Expiry Date : </span><span id="mm_mock">{{payment.mm}}</span> /
                    <span id="yy_mock">{{payment.yyyy}}</span>
                  </strong>
            ...
            <div class="card-data flex-fill flex-vertical">
              ...
              <div class="flex-between">
                <div class="card-number flex-vertical-center flex-fill">
                  <div class="card-number-field flex-vertical-center flex-fill">
                    ...
                    <InputText type="text" v-model="payment.creditcard" />
                  </div>
              ...
              <div class="flex-between">
                ...
                <div class="card-property-value flex-vertical-center">
                  <div class="input-container half-width">
                    <InputText class="border-bottom-1 border-none border-solid border-black-alpha-50" type="text" v-model="payment.mm" />
                  </div>
                  <span class="m-md">/</span>
                  <div class="input-container half-width">
                    <InputText class="border-bottom-1 border-none border-solid border-black-alpha-50" type="text" v-model="payment.yyyy" />
                  </div>
                </div>
              </div>
              ...
              <div class="flex-between">
                ...
                <div class="card-property-value">
                  <div class="input-container">
                    <InputOtp v-model="payment.cvc" :length="3" />
                  </div>
                </div>
              </div>
              ...
              <div class="flex-between">
                ...
                <div class="card-property-value">
                  <div class="input-container">
                    <InputText class="border-bottom-1 border-none border-solid border-black-alpha-50" type="text" v-model="payment.cardholder" />
                    <i class="ai-person"></i>
                  </div>
                </div>
              </div>
        ...
        <div class="col-lg-4 col-md-12 py-5">
          ...
          <div class="total-section flex-between flex-vertical-center">
            <div class="flex-fill flex-vertical">
              <div>
                <strong>{{payment.price}}</strong><span class="f-secondary-color">$</span>
                <Button class="ml-2" severity="info" label="Pay" outlined />
              </div>
            </div>
